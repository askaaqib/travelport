...
*/
$TARGETBRANCH = 'P7110410';
$CREDENTIALS = 'Universal API/uAPI3304653990-389045cb:3Dd}Jy!9+7';
...
function parseOutput($content){	//parse the Search response to get values to use in detail request
	...
	var_dump(json_encode(json_decode(json_encode((array)$newContent)), true));
